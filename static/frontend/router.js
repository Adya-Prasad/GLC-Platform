...
const MENUS = {
    borrower: [
        ...
        { id: 'documents', icon: 'M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z', label: 'My Documents' },
...
export function initRouter() {
    ...
    // Initial Route
    const defaultPage = user.role === 'borrower' ? 'my-applications' : 'dashboard';
    navigateTo(defaultPage);
}

function renderSidebar() {
    const role = user.role;
    const items = MENUS[role] || MENUS.borrower;
    ...
    try {
        switch (page) {
            ...
            case 'apply':
                ...
                break;
            case 'applications':
                title.textContent = 'All Applications';
